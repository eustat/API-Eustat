...
Datuak publikoak dira eta modu desberdinetan eskura daitezke, besteak beste,  [hemen dokumentatutako](https://github.com/eustat/API-Eustat/blob/main/README.md) APIaren bidez. APIak izugarri errazten du datuak eskuratzea eta berrerabiltzea. Hala ere, APIekin aurretik esperientziarik izan ezean, zaila izan daiteke ikertzaile, analista edo ikasle batentzat hura erabiltzea.
...
![](https://raw.githubusercontent.com/API-Eustat/main/img/Langabezia_aukeraketa.png){width="600"}
...
![](https://raw.githubusercontent.com/API-Eustat/main/img/Langabezia_kontsulta.png){width="600"}
