...
Los datos son públicos y accesibles por distintos medios, entre ellos la API, [documentada aquí](https://github.com/eustat/API-Eustat/blob/main/README.md). La API facilita enormemente el acceso y la reutilización de los datos. Sin embargo, a menos que se tenga experiencia previa en el acceso a API, su uso puede resultar complejo para un investigador, analista o estudiante.
